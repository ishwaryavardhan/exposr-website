...
export default function SMMImpactReveal() {
    const ref = useRef<HTMLDivElement>(null);
    const isInView = useInView(ref, { once: true, margin: "-15%" });

    const paragraph = "Social media isn't just about posting. It's about owning a conversation, building a loyal tribe, and architecting brand moments that compound into undeniable market authority.";
    ...
    return (
        <section className="relative bg-black text-white overflow-hidden py-40">
            ...
            <motion.div
                ...
                style={{
                    background: "radial-gradient(ellipse at center bottom, rgba(255,77,0,0.30) 0%, rgba(168,85,247,0.10) 50%, transparent 75%)",
                }}
            ...
            <div ref={ref} className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-12">
                ...
                >
                    ...
                    <span className="text-brand-orange text-xs font-black uppercase tracking-[0.3em]">The Social Advantage</span>
                </motion.div>
