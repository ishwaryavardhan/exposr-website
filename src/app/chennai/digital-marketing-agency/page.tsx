...
const services = [
    { icon: <Target size={28} />, title: "Performance Marketing", desc: "Data-led Google, Meta & LinkedIn campaigns engineered to maximize ROAS for Chennai brands." },
    { icon: <Search size={28} />, title: "SEO & AEO Optimization", desc: "Dominate local and national search. We rank Chennai businesses on page one and inside AI overviews." },
    { icon: <BarChart3 size={28} />, title: "Growth Consultancy", desc: "Full-funnel digital growth strategy tailored to Chennai's competitive market landscape." },
    { icon: <Video size={28} />, title: "Media Production", desc: "High-converting video and visual content crafted for Chennai's discerning audience." },
    { icon: <UsersIcon size={28} />, title: "Social Media Management", desc: "Hyper-local social presence that resonates with Chennai's unique culture and demographics." },
    { icon: <Zap size={28} />, title: "AI-Powered Marketing", desc: "Autonomous marketing systems that learn and scale 10x faster than traditional agencies." }
];
...
const projects = [
    ...
    { title: 'Interior Design Growth', category: 'Performance Marketing', description: 'Generated high-quality leads for premium interior design services using visually compelling search and display ads.', image: '/case studies/Exposr/portfolio- PPC/screen shots/Interior Design.png' },
...
const chennaiLocalFaqs = [
    { question: 'Why choose eXposr as your digital marketing consultancy in Chennai?', answer: 'eXposr is India\'s first Agentic AI digital marketing agency with deep expertise in scaling Chennai brands. We combine autonomous AI systems with Chennai-specific market intelligence to deliver measurably superior results across SEO, PPC, and performance marketing channels.' },
    { question: 'What industries do you serve in Chennai?', answer: 'We specialize in EdTech, FinTech, E-Commerce, Real Estate, Healthcare, Hospitality, and SaaS businesses in Chennai. Our campaigns are tailored to the specific buyer behavior patterns unique to the Chennai market.' },
    { question: 'How quickly can you scale a Chennai business with digital marketing?', answer: 'Paid channels typically show measurable results within 2-4 weeks. Organic SEO for Chennai local search builds over 3-6 months with compounding returns. We build a blended strategy for both immediate pipeline and sustainable long-term growth.' },
    { question: 'Do you offer local SEO for businesses targeting Chennai customers?', answer: 'Absolutely. We run comprehensive local SEO strategies including Google Business Profile optimization, Chennai-specific keyword targeting, local citation building, and review management to ensure you dominate Chennai local search results.' },
    { question: 'What makes eXposr different from other digital marketing agencies in Chennai?', answer: 'eXposr is the only Agentic AI marketing agency operating in Chennai. We don\'t just use AI tools — we build autonomous marketing systems. Our teams of performance engineers, AI architects, and creative strategists deliver higher output, faster iteration cycles, and measurably better KPIs than conventional Chennai agencies.' },
];
...
export default function ChennaiDigitalMarketingPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setError('');
        try {
            const res = await fetch('/api/leads', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ ...formData, source: 'Chennai Location Page' }) });
    ...
    return (
        <div className="flex flex-col min-h-screen bg-white overflow-hidden">
            ...
            <section className="relative bg-black pt-44 pb-32 px-6 overflow-hidden">
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_left,rgba(255,77,0,0.15)_0%,transparent_60%)] pointer-events-none" />
                <div className="container mx-auto relative z-10">
                    <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="max-w-5xl">
                        <div className="flex items-center gap-3 mb-8">
                            ...
                            <span className="text-brand-orange text-[11px] font-black uppercase tracking-[0.3em]">Chennai, Tamil Nadu</span>
                        </div>
                        ...
                        <p className="text-xl text-white/60 font-medium leading-relaxed max-w-2xl mb-12">
                            eXposr is Chennai's premier AI-powered digital growth consultancy. We engineer performance-led marketing systems that scale Tamil Nadu brands with precision and speed.
                        </p>
            ...
            <section className="py-28 px-6 bg-white">
                <div className="container mx-auto">
                    <div className="max-w-3xl mb-20">
                        ...
                        <p className="text-xl text-black/50 font-medium leading-relaxed">End-to-end digital marketing services for Chennai businesses — from acquisition to retention.</p>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between mb-24 gap-12">
                        ...
                        <div className="max-w-md">
                            <p className="text-xl text-black/50 font-medium leading-relaxed">
                                Specialized growth strategies for Chennai's most competitive market verticals.
                            </p>
                        </div>
                    </div>
            ...
            <AeoFaqs
                ...
                subtitle="Everything you need to know about eXposr's digital marketing services in Chennai."
                faqs={chennaiLocalFaqs}
            />

            {/* ── Why Chennai Brands Choose eXposr ── */}
            <section className="py-28 px-6 bg-black">
                <div className="container mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                        <div>
                            <h2 className="text-5xl md:text-6xl font-black text-white tracking-tighter leading-[0.9] uppercase mb-8">
                                Why Chennai Brands<br />
                            ...
                            <p className="text-xl text-white/50 font-medium leading-relaxed mb-12">
                                We understand Chennai's unique business ecosystem — from Anna Nagar to OMR's tech corridor. Our strategies are localized for Tamil Nadu market dynamics.
                            </p>
                            <div className="space-y-6">
                                {[
                                    "Deep knowledge of Chennai's hyper-competitive local search landscape",
                                    "Campaigns tailored for Tamil Nadu buyer behavior and language preferences",
                                    "AI systems optimized for South Indian e-commerce and SaaS growth",
                                    "Track record scaling brands in IT, Healthcare, Real Estate & Retail in Tamil Nadu"
                                ].map((point, idx) => (
                        ...
                        <div className="space-y-6">
                            {[
                                ...
                                { icon: <Star size={24} />, title: "Chennai-Specific Insights", desc: "Deep Tamil Nadu market data informing every campaign decision." }
                            ].map((item, idx) => (
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
                        <div>
                            <h2 className="text-5xl md:text-6xl font-black text-black tracking-tighter leading-[0.9] uppercase mb-8">
                                Ready to Grow<br />
                                <span className="text-brand-orange italic font-serif font-normal">in Chennai?</span>
                            </h2>
                        ...
                        <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }}
                            ...
                            {success ? (
                                <div className="bg-green-50 border border-green-200 text-green-700 p-8 rounded-3xl flex flex-col items-center text-center space-y-4">
                                    ...
                                    <p className="font-medium">Our Chennai growth team will reach out within 24 hours.</p>
                                </div>
                            ) : (
