    ...
    return (
        <div ref={ref} className={`flex flex-col justify-center py-4 pt-0 transition-opacity duration-700 ${isActive ? 'opacity-100' : 'opacity-20'}`}>
            ...
            >
                ...
                <h3 className="text-3xl md:text-5xl lg:text-7xl font-semibold tracking-[-0.03em] leading-[1.1] mb-4">
                    {service.title}
                </h3>
    ...
    return (
        <section className="py-8 px-6 md:px-12 bg-white text-black font-sans relative overflow-visible">
            <div className="max-w-[1400px] mx-auto">
                {/* Header Section */}
                <div className="flex flex-col md:flex-row justify-between items-start gap-8 2">
                ...
                <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-start relative border-t border-black/5">
                    ...
                    <div className="hidden lg:flex lg:w-1/4 sticky top-8 h-fit self-start flex-col gap-10 py-10 z-20">
                    ...
                    <div className="w-full lg:w-3/4 "> {/* Bottom padding for scroll trigger space */}
                        {services.map((service, index) => (
